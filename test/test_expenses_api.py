...
from splashifypro.api.expenses_api import ExpensesApi
...
class TestExpensesApi(unittest.TestCase):
    ...
    def test_app_expenses_billing_logs_get(self) -> None:
        """Test case for app_expenses_billing_logs_get

        Billing log entries
        """
        pass

    def test_app_expenses_summary_get(self) -> None:
        """Test case for app_expenses_summary_get
