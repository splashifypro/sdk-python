...
from splashifypro.api.drip_campaigns_api import DripCampaignsApi


class TestDripCampaignsApi(unittest.TestCase):
    """DripCampaignsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DripCampaignsApi()

    def tearDown(self) -> None:
        pass

    def test_public_drip_campaigns_get(self) -> None:
        """Test case for public_drip_campaigns_get

        List drip campaigns
        """
        pass

    def test_public_drip_start_post(self) -> None:
        """Test case for public_drip_start_post
