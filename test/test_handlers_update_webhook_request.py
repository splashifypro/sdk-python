...
class TestHandlersUpdateWebhookRequest(unittest.TestCase):
    """HandlersUpdateWebhookRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandlersUpdateWebhookRequest:
        """Test HandlersUpdateWebhookRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandlersUpdateWebhookRequest`
        """
        model = HandlersUpdateWebhookRequest()
        if include_optional:
            return HandlersUpdateWebhookRequest(
                webhook_events = [
                    ''
                    ],
                webhook_url = ''
    ...
    def testHandlersUpdateWebhookRequest(self):
        """Test HandlersUpdateWebhookRequest"""
