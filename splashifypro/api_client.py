...
from splashifypro.configuration import Configuration
from splashifypro.api_response import ApiResponse, T as ApiResponseT
import splashifypro.models
from splashifypro import rest
from splashifypro.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/0.1.0-dev/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(splashifypro.models, klass)
