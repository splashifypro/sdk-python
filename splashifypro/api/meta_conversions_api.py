...
class MetaConversionsApi:
    ...
    @validate_call
    def public_capi_send_event_post(
        self,
        body: Annotated[Dict[str, Any], Field(description="CAPI payload (event_name, phone_number, value, currency)")],
        ...
        :param body: CAPI payload (event_name, phone_number, value, currency) (required)
        :type body: object
        ...
        _param = self._public_capi_send_event_post_serialize(
            body=body,
    ...
    @validate_call
    def public_capi_send_event_post_with_http_info(
        self,
        body: Annotated[Dict[str, Any], Field(description="CAPI payload (event_name, phone_number, value, currency)")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def public_capi_send_event_post_without_preload_content(
        self,
        body: Annotated[Dict[str, Any], Field(description="CAPI payload (event_name, phone_number, value, currency)")],
        _request_timeout: Union[
            None,
    ...
    def _public_capi_send_event_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/public/capi/send-event',
