...
class DripCampaignsApi:
    ...
    def public_drip_campaigns_get(
        ...
        _param = self._public_drip_campaigns_get_serialize(
    ...
    @validate_call
    def public_drip_campaigns_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def public_drip_campaigns_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _public_drip_campaigns_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/public/drip/campaigns',
    ...
    @validate_call
    def public_drip_start_post(
        self,
        request: Annotated[Dict[str, Any], Field(description="campaign_id and phone_number")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param request: campaign_id and phone_number (required)
        :type request: object
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._public_drip_start_post_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def public_drip_start_post_with_http_info(
        self,
        request: Annotated[Dict[str, Any], Field(description="campaign_id and phone_number")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def public_drip_start_post_without_preload_content(
        self,
        request: Annotated[Dict[str, Any], Field(description="campaign_id and phone_number")],
        _request_timeout: Union[
            None,
    ...
    def _public_drip_start_post_serialize(
        self,
        request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/public/drip/start',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
